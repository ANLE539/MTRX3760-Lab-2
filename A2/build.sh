...
g++ -std=c++17 -Wall -Wextra main.cpp CRender.cpp CLoopReader.cpp \
    CSegmentLoop.cpp CRoom.cpp CFloorLine.cpp CTrail.cpp CDifferentialDrive.cpp \
    CRangeSensor.cpp CLineSensor.cpp CRobot.cpp CWallFollowerRobot.cpp \
    CLineFollowerRobot.cpp CSimulation.cpp \
    -lraylib -o A2
